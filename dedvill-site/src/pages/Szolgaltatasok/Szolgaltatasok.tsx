        ...
        <div className="grid-auto-fit services-grid">
          ...
          <div className="card service-block">
            ...
            <button
              className="more-btn"
              onClick={() =>
                openModal("Lakossági villanyszerelés",
                  <>
          ...
          <div className="card service-block">
            ...
            <button
              className="more-btn"
              onClick={() =>
                openModal("Mérőhely szabványosítás",
                 <>
          ...
          <div className="card service-block">
            ...
            <p>Részletek a <Link to="/vbf">VBF</Link> oldalon.</p>
            <ul>
          ...
          <div className="card service-block">
            ...
            <button
              className="more-btn"
              onClick={() =>
                openModal("Regisztrált szerelői tevékenység",
                 <>
          ...
          <div className="card service-block">
            ...
            <button
              className="more-btn"
              onClick={() =>
                openModal("Elektromos autótöltő telepítés",
